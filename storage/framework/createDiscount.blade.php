                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <div
                                            class="custom-control custom-switch custom-switch-success custom-switch-glow custom-control-inline mb-1 d-block">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control pickadate" name="active_from" placeholder="Выбрать дату" value="">
                                    ...
                                    <div class="mb-1">
                                        <h6>Активность до </h6>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control pickadate" name="active_to" placeholder="Выбрать дату" value="">
                                            <div class="form-control-position">
                                                <i class='bx bx-calendar'></i>
                                            </div>
                                        </fieldset>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="dropzone dropzone-area upload-discount-photo">
                                ...
                                <input type="hidden" class="discount_img_path"  name="img_path" value="">
                            </div>
                            ...
                            <fieldset class="form-group">
                                ...
                                <select class="form-group" name="discount_param">
                                     @foreach(\App\Models\SeasonDiscount::DISCOUNT_PARAM_LABELS as $discountParamKey => $discountParamValue)
                                        <option value="{{$discountParamKey}}"> {{$discountParamValue}}</option>
                                     @endforeach
                                </select>
                            </fieldset>
                            ...
                            <fieldset class="form-group">
                                ...
                                <select class="form-group" name="condition_discount_type">
                                    @foreach(\App\Models\SeasonDiscount::CONDITION_DISCOUNT_TYPE_LABELS as $discountConditionTypeKey => $discountConditionTypeValue)
                                        <option value="{{$discountConditionTypeKey}}"> {{$discountConditionTypeValue}} </option>
                                    @endforeach
                                </select>
                            </fieldset>
                            <fieldset class="form-group">
